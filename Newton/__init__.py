...
if ENV:
    ...
    NEWTON_PHOTO = os.environ.get('NEWTON_PHOTO', True)
    GROUP_START_IMG = os.environ.get('GROUP_START_IMG',None)
    HELP_IMG = os.environ.get('HELP_IMG',None)

else:
    from Newton.config import Development as Config
    TOKEN = Config.TOKEN
    try:
...
from Newton.modules.helper_funcs.handlers import CustomCommandHandler
