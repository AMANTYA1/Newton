...
import Newton.modules.sql.welcome_sql as sql
from Newton import dispatcher, OWNER_ID, LOGGER, MESSAGE_DUMP
from Newton.modules.helper_funcs.chat_status import user_admin, is_user_ban_protected
from Newton.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Newton.modules.helper_funcs.msg_types import get_welcome_type
...
from Newton.modules.feds import welcome_fed
    ...
    if should_welc:
        ...
        for new_mem in new_members:
            ...
            # Give start information when add bot to group
                ...
                bot.send_message(chat.id, "Thanks for adding me into your group! Checkout our Group!")
