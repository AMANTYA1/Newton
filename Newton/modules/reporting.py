...
from Newton.modules.helper_funcs.chat_status import user_not_admin, user_admin
from Newton.modules.log_channel import loggable
from Newton.modules.sql import reporting_sql as sql
...
def control_panel_user(update, context):
    user = update.effective_user  # type: Optional[User]
...
cntrl_panel_user_callback_handler = CallbackQueryHandler(control_panel_user, pattern=r"panel_reporting_U", run_async=True)
