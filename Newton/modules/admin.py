...
from Newton import SUDO_USERS, dispatcher, telethn as bot
from Newton.modules.disable import DisableAbleCommandHandler
from Newton.modules.helper_funcs.chat_status import (
    bot_admin,
    can_pin,
    can_promote,
    user_admin,
...
from Newton.modules.helper_funcs.extraction import (
    extract_user,
