...
import Newton.modules.sql.locks_sql as sql
from Newton import dispatcher, SUDO_USERS, LOGGER
from Newton.modules.disable import DisableAbleCommandHandler
from Newton.modules.helper_funcs.chat_status import can_delete, is_user_admin, user_not_admin, user_admin, \
    bot_can_delete, is_bot_admin, user_can_change
from Newton.modules.log_channel import loggable
from Newton.modules.sql import users_sql
